	...
	<div class="container-fluid">
	  ...
	  <div class="collapse navbar-collapse" id="ftco-nav">
		...
		<ul class="nav navbar-nav " >
			...
			<li class="nav-item"><a  style="font-size: 20px" class="nav-link" href="{{asset('/introduce2')}}" >Giới Thiệu</a></li>
			...
			<li  class="nav-item dropdown ">
				<a style="font-size: 20px" class="nav-link dropdown-toggle"  href="#" id="dropdownId" data-hover="dropdown" data-delay="30000" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Sách</a>
					<div class="dropdown-menu " aria-labelledby="dropdownId" >
		...
		<div class="container-fluid">
			<div class="row">
				...
				{{-- <div id="main" class="col-md-2">
					<nav id="menu" style="font-weight: bold; color: white" >
						<ul>
							<li class="menu-item" style=" background-color: #d86843">Danh mục tin tức</li>
							@foreach ($information as $cate)
