						...
						<div class="bootstrap-table">
							<table class="table table-bordered">
								...
								<td>{{$menu->menu_name}}</td>
									<td>
									<a href="{{asset('admin/menu/edit/'.$menu->menu_id)}}" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span><i class="fas fa-pencil-alt" aria-hidden="true"></i> Sửa</a>
			                    		<a href="{{asset('admin/menu/delete/'.$menu->menu_id)}}" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
			                  		</td>
								  </tr>
								  @endforeach
				                </tbody>
