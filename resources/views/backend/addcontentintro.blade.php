...
@section('title','Thêm Phần Giới Thiệu');
@section('main')
		...
		<div class="row">
			<div class="col-xs-12 col-md-12 col-lg-12">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">Thêm Phần Giới Thiệu</div>
						...
						<script type="text/javascript">
							var editor = CKEDITOR.replace('description',{
								...
								filebrowserFlashUploadUrl: '../../editor/public/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash',
									...
									<div class="form-group" >
										...
										<select required name="intro" class="form-control">
											@foreach ($introlist as $cate)
												<option value="{{$cate->intro_id}}">{{$cate->intro_name}}</option>
											@endforeach
					                    </select>
									</div>
									...
									<a href="{{asset('admin/contentintro')}}" class="btn btn-danger">Hủy bỏ</a>
								</div>
							</div>
							{{(csrf_field())}}
						</form>
