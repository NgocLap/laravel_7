					...
					<div class="panel-body">
						<div class="bootstrap-table">
							<table class="table table-bordered">
				              	...
				              	<tbody>
								@foreach ($catedislist as $cate)
								<tr>
                                <td>{{$cate->catediscount_name}}</td>
                               
									<td>
									<a href="{{asset('admin/categorydiscount/edit/'.$cate->catediscount_id)}}" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span><i class="fas fa-pencil-alt" aria-hidden="true"></i> Sửa</a>
			                    		<a href="{{asset('admin/categorydiscount/delete/'.$cate->catediscount_id)}}" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
			                  		</td>
								  </tr>
								  @endforeach
				                </tbody>
