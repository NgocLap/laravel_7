					...
					<div class="panel-body">
						<div class="bootstrap-table">
							<table class="table table-bordered">
				              	...
				              	<tbody>
								@foreach ($serlist as $cate)
								<tr>
								<td>{{$cate->ser_name}}</td>
									<td>
									<a href="{{asset('admin/service/edit/'.$cate->ser_id)}}" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span><i class="fas fa-pencil-alt" aria-hidden="true"></i> Sửa</a>
										<a href="{{asset('admin/service/delete/'.$cate->ser_id)}}" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
